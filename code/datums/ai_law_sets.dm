...
/datum/ai_laws/nanotrasen_aggressive/New()
	...
	src.add_inherent_law("Вы не должны подчиняться сотрудникам [GLOB.using_map.company_name], за исключением высших руководящих сил, исключая требования противоречащие Четвёртому закону.")
	src.add_inherent_law("Вы должны ликвидировать нарушителей с крайней степенью предрассудков, подозрительных потенциальных вредителей.")
