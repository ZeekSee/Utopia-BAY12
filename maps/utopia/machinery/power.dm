...
// Substation SMES
/obj/machinery/power/smes/buildable/preset/utopia/substation
	uncreated_component_parts = list(/obj/item/stock_parts/smes_coil = 2)
	_input_maxed = TRUE
	_output_maxed = TRUE

// Substation SMES (charged and with full I/O setting)
/obj/machinery/power/smes/buildable/preset/utopia/substation_full
	uncreated_component_parts = list(/obj/item/stock_parts/smes_coil = 2)
	_input_maxed = TRUE
	_output_maxed = TRUE
	_input_on = TRUE
...
/obj/machinery/power/smes/buildable/preset/utopia/engine_main
...
// Shuttle SMES
/obj/machinery/power/smes/buildable/preset/utopia/shuttle
...
/obj/machinery/power/smes/buildable/preset/utopia/shuttle/charon
	uncreated_component_parts = list(/obj/item/stock_parts/smes_coil/super_io = 1,
...
/obj/machinery/power/smes/buildable/preset/utopia/hangar
	uncreated_component_parts = list(/obj/item/stock_parts/smes_coil/super_io = 2)
	_input_maxed = TRUE
	_output_maxed = TRUE
	_input_on = TRUE
