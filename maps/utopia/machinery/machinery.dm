...
/obj/machinery/drone_fabricator/utopia
	fabricator_tag = "SSS Utopia Maintenance"

/obj/machinery/drone_fabricator/utopia/adv
...
/obj/machinery/turretid/utopia_bridge
	lethal = 1
