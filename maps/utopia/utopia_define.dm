/datum/map/utopia
	...
	station_name  = "SSS Utopia"
	station_short = "Utopia"
	dock_name     = "TBD"
	boss_name     = "Administrative Department"
	boss_short    = "Admindep"
	company_name  = "Galactic Council"
	company_short = "GC"

	map_admin_faxes = list("Galactic Council's Central Office")
