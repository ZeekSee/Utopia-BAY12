...
/datum/gear/suit/medical_poncho
	allowed_roles = list(/datum/job/cmo, /datum/job/senior_doctor, /datum/job/doctor, /datum/job/doctor_trainee, /datum/job/psychiatrist, /datum/job/chemist, /datum/job/submap/merchant, /datum/job/submap/merchant_trainee)

/datum/gear/suit/engineering_poncho
	allowed_roles = list(/datum/job/chief_engineer, /datum/job/senior_engineer, /datum/job/engineer, /datum/job/engineer_trainee, /datum/job/submap/merchant, /datum/job/submap/merchant_trainee, /datum/job/infsys)

/datum/gear/suit/science_poncho
	allowed_roles = list(/datum/job/submap/merchant, /datum/job/submap/merchant_trainee)
...
/datum/gear/suit/wintercoat/dais
	...
	allowed_roles = list(/datum/job/engineer, /datum/job/infsys)
