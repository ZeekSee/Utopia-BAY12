...
/datum/gear/accessory/pilot_pin
	...
	// [INF]
	// allowed_roles = list(/datum/job/captain, /datum/job/hop, /datum/job/adjutant)
...
/datum/gear/accessory/armband_emt
	allowed_roles = list(/datum/job/doctor, /datum/job/doctor_trainee)
...
/datum/gear/utility/holster_belt
	...
	allowed_roles = list(/datum/job/captain, /datum/job/hop, /datum/job/cmo, /datum/job/chief_engineer, /datum/job/hos, /datum/job/iaa, /datum/job/adjutant)
