...
/obj/item/book/manual/nt_sop
	name = "Utopia Standard Operating Procedures"
	desc = "SOP aboard the SSS Utopia."
...
/obj/item/book/manual/nt_tc
	name = "Utopia Threat Codes"
	desc = "TC aboard the SSS Utopia."
	icon = 'infinity/icons/obj/library.dmi'
	icon_state = "bookUtc"
...
/obj/item/paper/sierra/blanks
	...
	<b>КОМУ:</b> Исследовательскому Директору SSS Utopia<br>
	<b>А ТАКЖЕ:</b> Агенту Внутренних Дел SSS Utopia<br>
...
/obj/item/folder/envelope/captain/Initialize()
	...
	<b>ОТ:</b> Swadian Barwuds<br>
	<b>КОМУ:</b> Капитану SSS Utopia<br>
