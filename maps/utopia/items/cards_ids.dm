...
/obj/item/card/id/sierra
	...
	desc = "An identification card issued to personnel aboard the SSS Utopia."
...
/obj/item/card/id/sierra/passenger
	desc = "An identification card issued to passengers aboard the SSS Utopia."
	job_access_type = /datum/job/assistant
	color = "#ccecff"

/obj/item/card/id/sierra/crew
	desc = "An identification card issued to NanoTrasen crewmembers aboard the SSS Utopia."
	job_access_type = /datum/job/assistant
	color = "#ccecff"

/obj/item/card/id/sierra/crew/medical
	desc = "An identification card issued to medical crewmembers aboard the SSS Utopia."
...
/obj/item/card/id/sierra/crew/security
	desc = "An identification card issued to asset protection depatment's personnel aboard the SSS Utopia."
...
/obj/item/card/id/sierra/crew/engineering
	desc = "An identification card issued to engineering personnel aboard the SSS Utopia."
...
/obj/item/card/id/sierra/crew/service //unused
	desc = "An identification card issued to service personnel aboard the SSS Utopia."
...
/obj/item/card/id/sierra/crew/liaison
	desc = "A card issued to corporate represenatives aboard the SSS Utopia."
...
/obj/item/card/id/sierra/crew/adjutant
	desc = "A card issued to command's support personnel aboard the SSS Utopia."
...
/obj/item/card/id/sierra/stowaway
	desc = "An identification card issued to personnel aboard the SSS Utopia. Looks like the photo fell off this one."
