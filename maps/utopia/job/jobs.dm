...
#define HUMAN_ONLY_JOBS /datum/job/captain, /datum/job/hos, /datum/job/hop, /datum/job/chief_engineer, /datum/job/cmo, /datum/job/iaa, /datum/job/psychiatrist
	species_to_job_blacklist = list(
		/datum/species/unathi  		 = list(HUMAN_ONLY_JOBS, /datum/job/adjutant, /datum/job/senior_doctor),
		/datum/species/unathi/yeosa  = list(HUMAN_ONLY_JOBS, /datum/job/captain, /datum/job/hos, /datum/job/security_assistant, /datum/job/psychiatrist,\
									/datum/job/iaa, /datum/job/adjutant,),
		/datum/species/unathi/erosan = list(HUMAN_ONLY_JOBS, /datum/job/captain, /datum/job/hos, /datum/job/security_assistant, /datum/job/psychiatrist,\
									/datum/job/iaa, /datum/job/adjutant,),
		/datum/species/skrell  		 = list(HUMAN_ONLY_JOBS, /datum/job/captain, /datum/job/hos, /datum/job/security_assistant, /datum/job/psychiatrist,\
									/datum/job/iaa, /datum/job/adjutant,),
		...
		/datum/species/machine 		 = list(HUMAN_ONLY_JOBS, /datum/job/captain, /datum/job/hos, /datum/job/security_assistant, /datum/job/psychiatrist,\
									/datum/job/iaa, /datum/job/adjutant,),
		/datum/species/resomi  		 = list(HUMAN_ONLY_JOBS, /datum/job/senior_doctor,\
									/datum/job/senior_engineer, /datum/job/engineer, /datum/job/infsys, /datum/job/engineer_trainee,\
									/datum/job/warden, /datum/job/detective, /datum/job/officer, /datum/job/security_assistant,\
									/datum/job/qm,\
									/datum/job/iaa, /datum/job/adjutant,\
		...
		/datum/species/diona   		 = list(HUMAN_ONLY_JOBS, /datum/job/senior_doctor,\
									/datum/job/senior_engineer, /datum/job/engineer, /datum/job/infsys, /datum/job/engineer_trainee,\
									/datum/job/warden, /datum/job/detective, /datum/job/officer, /datum/job/security_assistant,\
									/datum/job/qm,\
									/datum/job/iaa, /datum/job/adjutant,\
		...
		/* /datum/species/human/booster= list(HUMAN_ONLY_JOBS,\
									/datum/job/adjutant, /datum/job/senior_engineer,\
									/datum/job/warden, /datum/job/detective, /datum/job/officer,
									/datum/job/qm) */
	)
#undef HUMAN_ONLY_JOBS

	allowed_jobs = list(/datum/job/captain, /datum/job/hop, /datum/job/cmo, /datum/job/chief_engineer, /datum/job/hos,
						/datum/job/iaa, /datum/job/adjutant,
						/datum/job/senior_engineer, /datum/job/engineer, /datum/job/infsys, /datum/job/engineer_trainee,
						/datum/job/warden, /datum/job/detective, /datum/job/officer, /datum/job/security_assistant,
						/datum/job/senior_doctor, /datum/job/doctor, /datum/job/doctor_trainee, /datum/job/chemist, /datum/job/psychiatrist,
...
/*
/datum/map/sierra_utopia/setup_map()
	..()
...
/datum/map/utopia
	default_assistant_title = "Utopian"
